                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-lg-7 mt-50">
                                        ...
                                        <span className="tag-1 col-lg-7 col-md-4 col-sm-3 col-12 bg-green-900">Want to Know how we find the BPO, BPM & ITES stars?</span>
                                        ...
                                        <div className="mt-50">
                                            <div className="row">
                                                ...
                                                <div className="col-lg-3 col-sm-4 col-4">
                                                    <h3 className="text-heading-4 color-gray-900 mb-15">
                                                        <span className="count">97.23</span>%
                                                    </h3>
                                                    <p className="text-body-text-md color-gray-500">
                                                        Client Satisfaction
                                                    </p>
                                    ...
                                    <div className="col-lg-5 d-none d-lg-block">
                                        <div className="banner-imgs">
                                            ...
                                            <img className="img-responsive shape-1" style={{borderRadius:"30px"}} alt="Agon" src="assets/imgs/page/homepage2/bpo1.png" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-lg-6 col-sm-12 block-img-we-do">
                                    <div className="inner-image">
                                        <img className="bdrd-16 img-responsive" src="assets/imgs/page/homepage2/bpo2.png" alt="Agon" />
                        ...
                        <div className="container mt-90 mb-lg-100">
                            <div className="row">
                                <div className="col-lg-6 col-sm-12" >
                                    <div className="bg-8 box-square hover-up wow animate__animated animate__fadeIn" data-wow-delay=".1s" >
                                        ...
                                        <div className="box-image-inner" style={{backgroundColor:"#a9adbb"}}>
                                            <img src="/assets/imgs/page/homepage2/bpo3.png" alt="Agon" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6 col-sm-12">
                                    <div className="bg-6 box-square hover-up wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                                        ...
                                        <div className="box-image-inner" style={{backgroundColor:"#a9adbb"}}>
                                            <img src="/assets/imgs/page/homepage2/bpo4.png" alt="Agon" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="container mt-80">
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-sm-12 block-we-do">
                                    <div className="inner-image">
                                        <img className="bdrd-16 img-responsive" src="assets/imgs/page/homepage2/bpo5.png" alt="Agon" />
                                        {/* <div className="block-image-bottom">
                                            <img className="bdrd-16 img-responsive" src="assets/imgs/page/homepage2/bpo6.png" alt="Agon" />
                                        </div> */}
                                    </div>
                                </div>
                            </div>
...
export default dynamic (() => Promise.resolve(Bpo_Bpm_Ites), {ssr: false})