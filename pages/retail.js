                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-lg-7 mt-50">
                                        <span className="tag-1 bg-green-900">Eager to uncover our approach to sourcing top talent in the Retail industry?</span>
                                        <h1 className="text-display-3 mt-30">
                                            Empowering Retail Excellence: Explore Our Talent Acquisition Solutions 
                                        </h1>
                                        <p className="text-body-lead color-gray-500 mt-40 pr-40" style={{ fontSize: "18px" }}>
                                            Delve into our innovative strategies for identifying top talent in the dynamic Retail sector. Learn how we leverage our extensive industry experience and strategic partnerships to connect skilled professionals with exciting opportunities in Retail.
                                        </p>
                                        <div className="mt-40">
                                    ...
                                    <div className="col-lg-5 d-none d-lg-block">
                                        <div className="banner-imgs">
                                            ...
                                            <img className="img-responsive shape-1" alt="Agon" style={{borderRadius:"30px"}} src="assets/imgs/page/homepage2/retail1.png" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-lg-6 col-sm-12 block-img-we-do">
                                    <div className="inner-image">
                                        <img className="bdrd-16 img-responsive" src="assets/imgs/page/homepage2/retail2.png" alt="Agon" />
                                        {/* <div className="block-chart">
                                            <img src="/assets/imgs/page/homepage2/retail2.png" alt="Agon" />
                                        </div> */}
                                    </div>
                                </div>
                                <div className="col-lg-6 col-sm-12 block-we-do-2">
                                    ...
                                    <h3 className="text-heading-2 mt-30">
                                        Revolutionizing Retail Recruitment 
                                    </h3>
                                    <p className="text-body-lead color-gray-600 mt-30" style={{ fontSize: "18px" }}>
                                        Discover our tailored recruitment process designed specifically for the Retail sector. With a blend of cutting-edge technology and industry expertise, we ensure a seamless and effective recruitment experience. 
                                    </p>
                                    <div className="list-icons mt-50">
                                        <div className="item-icon none-bd">
                                            ...
                                            <p className="text-body-excerpt color-gray-600 mt-15">
                                                Utilizing advanced algorithms and data analytics to identify candidates with the right skills and experience for Retail roles.
                                            </p>
                                        </div>
                                        <div className="item-icon none-bd">
                                            ...
                                            <p className="text-body-excerpt color-gray-600 mt-15">
                                                Conducting thorough evaluations to assess candidates&#39; customer service skills, sales acumen, and ability to thrive in a fast-paced Retail environment.
                                            </p>
                                        </div>
                                        <div className="item-icon none-bd">
                                            ...
                                            <p className="text-body-excerpt color-gray-600 mt-15">
                                                Collaborating closely with clients to understand their unique Retail staffing needs and deliver personalized recruitment solutions that drive business success.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-9 col-sm-11 col-12 text-center mt-40">
                                    <h2 className="text-heading-1 color-gray-900 mb-10">
                                        Cultivating Strategic Partnerships in Retail Recruitment 
                                    </h2>
                                    <p className="text-body-lead-large color-gray-600 mt-20">
                                    Explore our client-centric approach to Retail recruitment, where we prioritize building long-term relationships and delivering customized solutions to meet our clients&#39; evolving needs. 
                                    </p>
                                </div>
                                ...
                                <div className="col-lg-6 col-sm-12">
                                    <div className="bg-2 box-square hover-up wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                        ...
                                        <p className="text-body-text-md color-gray-600">
                                            Working closely with clients to understand their Retail staffing challenges and develop tailored recruitment strategies aligned with their business objectives.
                                        </p>
                                        <div className="box-image-inner bg-color-1">
                                            <img src="/assets/imgs/page/homepage2/retail3.png" style={{borderRadius:"15px"}} alt="Agon" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6 col-sm-12">
                                    <div className="bg-6 box-square hover-up wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                                        ...
                                        <p className="text-body-text-md color-gray-600">
                                            Going beyond traditional recruitment methods to deliver results that support our clients&#39; success and drive innovation in the Retail sector.
                                        </p>
                                        <div className="box-image-inner bg-color-2">
                                            <img src="/assets/imgs/page/homepage2/retail4.png" style={{borderRadius:"15px"}} alt="Agon" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-lg-8 col-sm-10 col-12 text-center mt-40">
                                    <h2 className="text-heading-1 color-gray-900 mb-10">
                                        Expertise in Recruiting Retail Professionals 
                                    </h2>
                                    <p className="text-body-lead-large color-gray-600 mt-20">
                                        Discover our specialized expertise in recruiting Retail professionals to drive growth and success in the industry. With a focus on agility and innovation, we identify and nurture talent that helps Retail businesses thrive. 
                                    </p>
                                </div>
                                <div className="col-lg-2 col-sm-1 col-12" />
                            </div>
                                    ...
                                    <div className="list-icons mt-50">
                                        <div className="item-icon">
                                            ...
                                            <p className="text-body-text color-gray-600 mt-15">
                                                Identifying and cultivating Retail professionals with exceptional customer service skills, product knowledge, and the ability to create memorable shopping experiences.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-5 col-md-12 col-sm-12">
                                    <div className="list-icons mt-50">
                                        <div className="item-icon">
                                            ...
                                            <h4 className="text-heading-4">
                                                Sales and Merchandising Proficiency
                                            </h4>
                                            <p className="text-body-text color-gray-600 mt-15">
                                                Partnering with clients to build Retail teams proficient in driving sales, managing inventory, and optimizing merchandising strategies.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="container mt-80">
                            <div className="row">
                                <div className="col-lg-6 col-sm-12 mb-30">
                                    <span className="tag-1 bg-6 color-green-900">Ready to elevate your Retail team to new heights?</span>
                                    <h3 className="text-heading-1 mt-30">
                                        Partner with HBR for Retail Hiring Excellence 
                                    </h3>
                                    <p className="text-body-lead-large color-gray-600 mt-30">
                                        Let&#39;s collaborate to build a high-performing Retail team that drives success and innovation in the industry. From recruitment to retention, we&#39;ll guide you through every step of the staffing process.  
                                    </p>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6 col-sm-6 col-12 mt-50">
                                            ...
                                            <p className="text-body-excerpt color-gray-600 mt-15">
                                                Fill out the form below to connect with our Retail recruitment specialists and discuss your staffing needs.
                                            </p>
                                        </div>
                                        <div className="col-lg-6 col-sm-6 col-12 mt-50">
                                            <h4 className="text-heading-6 icon-leaf">
                                            ...
                                            <p className="text-body-excerpt color-gray-600 mt-15">
                                                Schedule a consultation to explore customized recruitment solutions tailored to your organization&#39;s unique Retail requirements.
                                            </p>
                                        </div>
                                        <div className="col-lg-6 col-sm-6 col-12 mt-50">
                                            <h4 className="text-heading-6 icon-leaf">
                                            ...
                                            <p className="text-body-excerpt color-gray-600 mt-15">
                                            Partner with HBR to build a skilled Retail team that delivers exceptional customer experiences and drives business growth.
                                            </p>
                                        </div>
                                        <div className="col-lg-6 col-sm-6 col-12 mt-50">
                                            <h4 className="text-heading-6 icon-leaf">
                                            ...
                                            <p className="text-body-excerpt color-gray-600 mt-15">
                                                Discover why leading Retail brands trust HBR for recruitment excellence and join them in shaping the future of the industry.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6 col-sm-12 block-we-do">
                                    <div className="inner-image">
                                        <img className="bdrd-16 img-responsive" src="assets/imgs/page/homepage2/retail5.png" alt="Agon" />
...
export default dynamic (() => Promise.resolve(Retail), {ssr: false})